...
// forge create --rpc-url $QUICKNODE_RPC_URL --private-key $PRIVATE_KEY --constructor-args <token ca> --etherscan-api-key $ETHERSCAN_API_KEY --verify src/Exchange.sol:Exchange
// forge verify-contract <contract address> Exchange --chain sepolia
